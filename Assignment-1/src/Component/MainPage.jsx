            ...
            <div className="firstChild">
                ...
                <table className="table">
                    <th className="theader">
                        <td className="td_pages td1"><span className="heading">Pages</span><img className="headingIcon" src={circle}/></td>
                        <td className="td_pages td2"><span className="heading">Design</span><img className="headingIcon" src={circle}/></td>
                        <td className="td_pages td2"><span className="heading">Interactions & Animations</span><img className="headingIcon" src={circle}/></td>
                        <td className="td_pages td2"><span className="heading">Integration</span><img className="headingIcon" src={circle}/></td>
                        <td className="td_pages td3 lastHeading"><span className="heading">Cost</span><img className="headingIcon" src={circle}/></td>
                    </th>
                    <tr className="tRow">
                        <td className="td1"><span className="numbering">01.</span><span className="rowContent">Home</span></td>
                    ...
                    <tr className="tRow">
                        <td className="td1"><span className="numbering">02.</span><span className="rowContent">Service</span></td>
                        <td className="td_Design td2">
                            <div className="Page_Slider">
                                <img className="minus" src={minus} alt="minus"/>
                    ...
                    <tr className="tRow">
                        <td className="td1"><span className="numbering">03.</span><span className="rowContent">About Us</span></td>
                        <td className="td_Design td2">
                            <div className="Page_Slider">
                                <img className="minus" src={minus} alt="minus"/>
                    ...
                    <tr className="tRow">
                        <td className="td1"><span className="numbering">04.</span><span className="rowContent">Partners</span></td>
                        <td className="td_Design td2">
                            <div className="Page_Slider">
                                <img className="minus" src={minus} alt="minus"/>
                                <span className="frame78 basic small">Basic</span>
                    ...
                    <tr className="tRow">
                        <td className="td1"><span className="numbering">05.</span><span className="rowContent">Contact Us</span></td>
                        <td className="td_Design td2">
                            <div className="Page_Slider">
                                <img className="minus" src={minus} alt="minus"/>
                                <span className="frame78 complex large">Complex</span>
